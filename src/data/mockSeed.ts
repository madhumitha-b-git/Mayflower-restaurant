...
export const MOCK_OUTLETS: SeedOutlet[] = [
  ...
  { id: 'o4', name: 'Egmore Heritage Manor', slug: 'egmore', badge: 'Heritage Manor', area: 'Egmore, Chennai', petpoojaId: 'PP-04', tablesCount: 20, coversCount: 80, isActive: true, openingTime: '12:00 PM', closingTime: '11:00 PM' },
];
...
export const MOCK_RESERVATIONS: SeedReservation[] = [
  ...
  { id: 'res-104', bookingCode: 'MF-8815', customerId: 'usr-customer-2', customerName: 'Rohan Gupta', email: 'customer2@gmail.com', phone: '+91 98400 88888', outlet: 'Egmore Heritage Manor', date: TODAY, timeSlot: '21:00', guests: 2, seatingArea: 'Heritage Cellar', status: 'Completed', bookedAt: '10 Sep 2026' },
