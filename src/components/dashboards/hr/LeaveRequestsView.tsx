...
import { Check, X, Clock, RefreshCw, Calendar } from 'lucide-react';
      ...
      <div className="bg-white/95 rounded-2xl p-5 border border-[#E8E3D8] shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-[#6B7280] mt-1">
            Review roster changes, shift swaps, and annual/medical leave applications across all outlets.
          </p>
        </div>
                  ...
                  {isPending ? (
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg text-xs font-semibold text-white bg-[#0B2B24] hover:bg-[#134238] flex items-center gap-1 shadow-xs cursor-pointer transition-colors"
