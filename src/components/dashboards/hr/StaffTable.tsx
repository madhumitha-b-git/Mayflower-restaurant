              ...
              <tr>
                <td colSpan={9} className="py-12 text-center text-[#707B75]">
                  ...
                  <p className="text-xs mt-1 text-[#8C9690]">
                    Try adjusting your search query or outlet filter.
                  </p>
                </td>
              </tr>
            ) : (
                  ...
                  >
                    ...
                    <td className="py-3.5 px-5">
                      <div className="flex items-center gap-3">
                        <div
                          className="w-9 h-9 rounded-full flex items-center justify-center text-white font-semibold text-xs shrink-0 shadow-xs"
