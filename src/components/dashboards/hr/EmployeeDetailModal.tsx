...
import { X, Clock, Phone, CheckCircle2, AlertCircle } from 'lucide-react';
            ...
            <button
              ...
              className={`py-2 px-1 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
                employee.dutyStatus === 'Clocked In'
                  ? 'bg-[#EAF7ED] text-[#15803D] border border-[#BDEBD0] shadow-xs'
            ...
            <button
              ...
              className={`py-2 px-1 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
                employee.dutyStatus === 'Off Duty'
                  ? 'bg-gray-200 text-[#1F2937] shadow-xs'
                  : 'bg-white text-[#5E6B64] border border-[#E8E3D8] hover:bg-gray-50'
              }`}
            >
            ...
            <button
              ...
              className={`py-2 px-1 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
                employee.dutyStatus === 'On Leave'
                  ? 'bg-[#F5F2FD] text-[#6D28D9] border border-[#DDD4F8] shadow-xs'
                  : 'bg-white text-[#5E6B64] border border-[#E8E3D8] hover:bg-gray-50'
              }`}
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full bg-[#FAF8F5] border border-[#E8E3D8] rounded-xl px-3 py-2 text-xs text-[#18231E] focus:outline-none focus:border-[#0B2B24] cursor-pointer"
              >
                {ALL_OUTLETS.map((out) => (
