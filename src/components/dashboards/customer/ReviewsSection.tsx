...
export const ReviewsSection: React.FC<ReviewsSectionProps> = ({ reviews, onOpenNewReview }) => {
  return (
    <section className="space-y-4" data-purpose="reviews-section">
      ...
      {/* Reviews List */}
      {reviews.length === 0 ? (
        <div className="bg-white rounded-xl border border-[#E8E2D5] p-8 text-center shadow-sm">
          <p className="font-serif text-lg text-stone-800">No dining reviews submitted yet.</p>
          <p className="text-xs text-stone-500 mt-1">Share your thoughts on your dining experience to earn +100 Mayflower Stars.</p>
        </div>
      ) : (
