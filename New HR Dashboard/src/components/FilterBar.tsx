...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className="w-full space-y-4">
      ...
      {activeTab === 'directory' && (
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white/95 border border-[#E8E3D8] rounded-xl px-4 py-2.5 shadow-2xs">
          <div className="flex items-center gap-2.5 flex-1">
            ...
            <input
              ...
              placeholder="Search by name, role, or salon location..."
              className="w-full bg-transparent text-xs sm:text-sm text-[#1A2520] placeholder-[#9CA3AF] focus:outline-hidden"
            />
            {searchQuery && (
              <button
