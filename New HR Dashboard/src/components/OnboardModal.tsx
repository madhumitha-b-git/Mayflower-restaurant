...
import { X, UserPlus, Sparkles, Building2, Clock, Phone, Mail, User } from 'lucide-react';
...
export const OnboardModal: React.FC<OnboardModalProps> = ({
  ...
  const [role, setRole] = useState('Salon Stylist & Colorist');
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-[#7A857F]">
                Assign to Salon & Fine Dining Roster (EMP-{nextNum})
              </p>
            </div>
          </div>
          <button
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="e.g. Master Stylist Rohan Verma"
                className="w-full bg-[#FAF8F5] border border-[#E8E3D8] rounded-xl pl-9 pr-3 py-2.5 text-xs text-[#18231E] focus:bg-white focus:outline-hidden focus:border-[#0B2B24]"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Master Colorist / Sous Chef"
                className="w-full bg-[#FAF8F5] border border-[#E8E3D8] rounded-xl px-3 py-2.5 text-xs text-[#18231E] focus:bg-white focus:outline-hidden focus:border-[#0B2B24]"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#FAF8F5] border border-[#E8E3D8] rounded-xl px-3 py-2.5 text-xs text-[#18231E] focus:bg-white focus:outline-hidden focus:border-[#0B2B24] cursor-pointer"
              >
                {ALL_OUTLETS.map((loc) => (
              ...
              {(['Clocked In', 'Off Duty', 'Scheduled'] as DutyStatus[]).map((status) => (
                <button
                  ...
                  className={`py-2 px-2 rounded-xl text-center font-medium transition-all cursor-pointer ${
                    dutyStatus === status
                      ? 'bg-[#0B2B24] text-white font-semibold shadow-2xs'
